...
{"すべてのキャンペーンをズラッと並べたぞい！" if "すべて" in user_message else "今おすすめの実施中キャンペーンを5つピックアップしてきたぞい。ほれ、これじゃ！"}\n
{campaign_text}\n
{'さらに知りたい情報があれば、気軽に聞いてくれい！' if "すべて" in user_message else 'もし『楽天ポイントのすべて』と打ち込んでくれれば、ワシが全部のキャンペーンをここにズラッと並べてやるからのう。スーパー名や自治体名でも探せるから、気軽に聞いてくれい！'}
        """
...
{"すべてのキャンペーンをズラッと並べたぞい！" if "すべて" in user_message else "今おすすめの実施中キャンペーンを5つピックアップしてきたぞい。ほれ、これじゃ！"}\n
{campaign_text}\n
{'さらに知りたい情報があれば、気軽に聞いてくれい！' if "すべて" in user_message else 'もし『Vポイントのすべて』と打ち込んでくれれば、ワシが全部のキャンペーンをここにズラッと並べてやるからのう。スーパー名や自治体名でも探せるから、気軽に聞いてくれい！'}
        """
...
{"すべてのキャンペーンをズラッと並べたぞい！" if "すべて" in user_message else "今おすすめの実施中キャンペーンを5つピックアップしてきたぞい。ほれ、これじゃ！"}\n
{campaign_text}\n
{'さらに知りたい情報があれば、気軽に聞いてくれい！' if "すべて" in user_message else 'もし『dポイントのすべて』と打ち込んでくれれば、ワシが全部のキャンペーンをここにズラッと並べてやるからのう。スーパー名や自治体名でも探せるから、気軽に聞いてくれい！'}
        """
...
{"すべてのキャンペーンをズラッと並べたぞい！" if "すべて" in user_message else "今おすすめの実施中キャンペーンを5つピックアップしてきたぞい。ほれ、これじゃ！"}\n
{campaign_text}\n
{'さらに知りたい情報があれば、気軽に聞いてくれい！' if "すべて" in user_message else 'もし『pontaのすべて』と打ち込んでくれれば、ワシが全部のキャンペーンをここにズラッと並べてやるからのう。スーパー名や自治体名でも探せるから、気軽に聞いてくれい！'}
        """